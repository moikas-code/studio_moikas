          ...
          <SignedOut>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white dark:bg-base-200 rounded-lg shadow-lg border border-jade p-6 relative">
                <div className="absolute top-0 right-0 bg-jade dark:text-white px-3 py-1 text-sm font-bold rounded-bl-lg rounded-tr-lg">
                  POPULAR
                </div>
                <h3 className="text-2xl font-bold text-jade mb-2">Standard</h3>
                <p className="text-3xl font-bold mb-4 text-gray-900 dark:text-white">
