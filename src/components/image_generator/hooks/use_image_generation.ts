...
export function useImageGeneration() {
  ...
  const generate_image = useCallback(
    async (params: GenerationParams): Promise<GenerationResult | null> => {
      set_is_loading(true);
      ...
      try {
        ...
        console.log(
          "[useImageGeneration] Cleaned params:",
          JSON.stringify(cleaned_params, null, 2)
        );
