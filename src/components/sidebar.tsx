...
export default function Sidebar({
  ...
  const [collapsed_sections, set_collapsed_sections] = useState<{ [key: string]: boolean }>({
    ...
    video: true, // Video tools Minimized by default
    audio: true, // Audio tools Minimized by default
    support: false, // Support expanded by default
  ...
  return (
    <>
      ...
      >
        <div className="p-3 border-b border-base-300">
          <div className="flex items-center justify-between">
            <h2
              className={`text-base font-medium text-center p-4 font-mono ${is_minimized ? "hidden" : "block"}`}
            >
              Studio Moikas
            </h2>
            <button
          ...
          <nav
            className={`border-base-300 ${is_minimized ? "py-2" : "p-4"}`}
          ...
          <div className={`${is_minimized ? "py-2" : "p-6"} border-b border-base-300`}>
            {!is_minimized && (
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${collapsed_sections.image ? "" : "rotate-180"}`}
                />
              </button>
            )}
          </div>
          {!collapsed_sections.image && (
            <nav
              className={`flex flex-col ${is_minimized ? "py-2" : "p-4"}`}
              aria-label="Image tools"
            >
              <ul
                className={`menu ${is_minimized ? "menu-sm" : "menu-lg"} rounded-box w-full ${is_minimized ? "[&_a]:!px-2" : ""}`}
              >
                <li>
                  <Link
                    href="/tools/create"
                  ...
                  >
                    ...
                    {!is_minimized && (
                      <span className="text-base font-medium text-md whitespace-nowrap">
                        Create
                      </span>
                    )}
                  </Link>
          ...
          <div className={`${is_minimized ? "py-2" : "p-6"} border-b border-base-300`}>
            {!is_minimized && (
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${collapsed_sections.video ? "" : "rotate-180"}`}
                />
              </button>
            )}
          </div>
          ...
          <div className={`${is_minimized ? "py-2" : "p-6"} border-b border-base-300`}>
            {!is_minimized && (
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${collapsed_sections.audio ? "" : "rotate-180"}`}
                />
              </button>
            )}
          </div>
          ...
          <div className={`${is_minimized ? "py-2" : "p-6"} border-b border-base-300`}>
            {!is_minimized && (
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${collapsed_sections.tools ? "" : "rotate-180"}`}
                />
              </button>
            )}
          </div>
              ...
              >
                <li>
                  ...
                  >
                    ...
                    {!is_minimized && (
                      <span className="text-base font-medium text-md whitespace-nowrap">MEMU</span>
                    )}
                  </Link>
                </li>
          ...
          <div className={`${is_minimized ? "p-2" : "p-6"} border-b border-base-300`}>
            {!is_minimized && (
              ...
              >
                ...
                <ChevronDown
                  className={`w-4 h-4 transition-transform ${collapsed_sections.support ? "" : "rotate-180"}`}
                />
              </button>
            )}
          </div>
              ...
              >
                <li>
                  ...
                  >
                    <span
                      ...
                      title={is_minimized ? "Community" : undefined}
                    >
                      {/* Discord icon */}
                      <Image
                        src="/Discord.svg"
                ...
                <li>
                  ...
                  >
                    <span
                      className="flex items-center gap-2 text-md"
                      title={is_minimized ? "News" : undefined}
                    >
              ...
              <div className={`${is_minimized ? "p-2" : "p-6"} border-b border-base-300`}>
                {!is_minimized && (
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-4 h-4 transition-transform ${collapsed_sections.admin ? "" : "rotate-180"}`}
                    />
                  </button>
                )}
              </div>
                  ...
                  >
                    <li>
                      ...
                      >
                        ...
                        {!is_minimized && (
                          <span className="text-base font-medium whitespace-nowrap">Dashboard</span>
                        )}
                      </Link>
                    </li>
                    <li>
        ...
        <div
          className={`${is_minimized ? "p-2" : "p-6"} flex justify-center border-b border-base-300`}
        >
          <SignedIn>
      ...
      <ReportBugMenu open={report_bug_open} on_close={() => set_report_bug_open(false)} />
    </>
  );
}
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-100/30">
      <div className="z-55 bg-base-100 rounded-lg shadow-xl p-0 w-full max-w-[600px] relative border border-base-300">
        ...
        <div className="px-8 pt-8 pb-6">
          ...
          <p className="text-base text-base-500 mb-4">
            We&apos;d love to hear what went well or how we can improve the product experience.
          </p>
          {submitted ? (
            <div className="text-success font-semibold text-center py-6">
...
function ReportBugMenu({ open, on_close }: { open: boolean; on_close: () => void }) {
  ...
  const username =
    ...
    user?.emailAddresses?.[0]?.emailAddress ||
    "User";
  const categories = ["UI Issue", "Performance", "Crash", "Data Loss", "Other"];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-100/30">
      <div className="z-55 bg-base-100 rounded-lg shadow-xl p-0 w-full max-w-[600px] relative border border-base-300">
        ...
        <div className="px-8 pt-8 pb-6">
          ...
          <p className="text-base text-base-500 mb-4">
            Help us improve by reporting any issues you encounter. Please select a category and
          ...
          {submitted ? (
            ...
            <form onSubmit={handle_submit} className="flex flex-col gap-4">
              ...
              >
                ...
                {categories.map((opt) => (
                  <option key={opt} value={opt} className="dark:text-base-100">
                    {opt}
                  </option>
                ))}
              </select>
