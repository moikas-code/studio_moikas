...
export default function Sidebar({ open = false, on_close }: { open?: boolean; on_close?: () => void }) {
  ...
  return (
    <>
      ...
      />
      <aside
        className={`hidden md:flex min-h-screen w-35 lg:w-64 max-w-full bg-base-200 border-r border-base-300 flex-col z-40 transition-transform duration-200  overflow-y-auto`}
      ...
      >
        ...
        <div className="p-6 border-b border-base-300">
          <p className="text-sm font-bold tracking-tight text-primary">Tools</p>
        </div>
