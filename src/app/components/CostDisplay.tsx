...
const CostDisplay: React.FC<CostDisplayProps> = ({ model }) => {
  ...
  return (
    <div className=" z-50 bg-base-100 border border-base-300 rounded-xl shadow-lg px-4 py-3 text-base text-base-700 flex flex-row items-center justify-between min-w-[150px] max-w-lg">
