...
import type { ModelConfig, ModelFormData, ModelType, SizeMode, PixelSize } from "@/types/models";
import {
  MODEL_TYPE_OPTIONS,
  SIZE_MODE_OPTIONS,
  ...
  const handle_submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (on_submit) {
        ...
        const url = model ? `/api/admin/models/${model.id}` : "/api/admin/models";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-control">
              <label className="label">
                ...
                <span className="label-text-alt">
                  Optional - distinguishes between different configurations
                </span>
              </label>
              <input
                type="text"
                className="input input-bordered"
                value={form_data.variant_name || ""}
                onChange={(e) =>
                  set_form_data({ ...form_data, variant_name: e.target.value || undefined })
                }
                placeholder="e.g., high-quality, fast, custom"
              />
            </div>
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) =>
                  set_form_data({ ...form_data, cost_per_mp: parseFloat(e.target.value) })
                }
                step="0.000001"
                required
              />
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) =>
                  set_form_data({ ...form_data, custom_cost: parseFloat(e.target.value) })
                }
                step="0.000001"
                required
              />
            ...
            <div className="form-control">
              ...
              <input
                ...
                onChange={(e) =>
                  set_form_data({ ...form_data, display_order: parseInt(e.target.value) })
                }
              />
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <label className="label cursor-pointer gap-2">
              <input
                ...
                onChange={(e) =>
                  set_form_data({ ...form_data, supports_image_input: e.target.checked })
                }
              />
          ...
          <div className="form-control">
            ...
            <select
              ...
              onChange={(e) =>
                set_form_data({
                  ...form_data,
                  billing_type: e.target.value as "flat_rate" | "time_based",
                })
              }
              required
            >
              ...
              <span className="label-text-alt">
                {
                  BILLING_TYPE_OPTIONS.find(
                    (opt) => opt.value === (form_data.billing_type || "flat_rate")
                  )?.description
                }
              </span>
            </label>
            ...
            <>
              <div className="alert alert-info mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    The base MP cost will be multiplied by the actual processing seconds
                  </p>
                  <p className="text-sm mt-1">
                    Example: If base cost is 1 MP and processing takes 3 seconds = 3 MP charged
                  </p>
                </div>
              </div>
                ...
                <div className="form-control">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      set_form_data({
                        ...form_data,
                        min_time_charge_seconds: parseFloat(e.target.value) || 1,
                      })
                    }
                    step="0.1"
                    min="0.1"
                ...
                <div className="form-control">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      set_form_data({
                        ...form_data,
                        max_time_charge_seconds: parseFloat(e.target.value) || undefined,
                      })
                    }
                    step="1"
                    placeholder="60"
          ...
          <div className="card-body">
            ...
            <div className="form-control">
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_both_size_modes: e.target.checked })
                  }
                />
                <span className="label-text">Supports Both Size Modes</span>
                <span className="text-xs text-base-content/60">
                  (Aspect Ratio + Custom Pixel Size)
                </span>
              </label>
            </div>
            ...
            <div className="form-control">
              ...
              <select
                ...
                onChange={(e) =>
                  set_form_data({ ...form_data, size_mode: e.target.value as SizeMode })
                }
              >
            ...
            {(form_data.size_mode === "pixel" || form_data.supports_both_size_modes) && (
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  ...
                  />
                  <button type="button" className="btn btn-primary btn-sm" onClick={add_pixel_size}>
              ...
              <div className={form_data.supports_both_size_modes ? "mt-4" : ""}>
                ...
                <div className="flex gap-2 mt-2">
                  <input
                    ...
                    onKeyPress={(e) =>
                      e.key === "Enter" && (e.preventDefault(), add_aspect_ratio())
                    }
                  />
                  <button
                    type="button"
            ...
            <div>
              <label className="label cursor-pointer justify-start gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_steps: e.target.checked })
                  }
                />
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            if (!e.target.checked) {
                              set_form_data({
                                ...form_data,
                                duration_options: form_data.duration_options?.filter(
                                  (d) => d !== duration
                                ),
                              });
                            }
        ...
        <div className="card bg-base-100 shadow-xl">
          <div className="card-body">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_loras: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_embeddings: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_controlnet: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_ip_adapter: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_prompt_weighting: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, has_safety_checker: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_custom_sigmas: e.target.checked })
                  }
                />
              ...
              <label className="label cursor-pointer gap-2">
                <input
                  ...
                  onChange={(e) =>
                    set_form_data({ ...form_data, supports_custom_timesteps: e.target.checked })
                  }
                />
              ...
              <div className="space-y-4 mb-4">
                <div className="form-control">
                  <label className="label">
                    ...
                    <span className="label-text-alt text-xs">
                      For custom SD/LoRA models (e.g., stabilityai/stable-diffusion-xl-base-1.0)
                    </span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="form-control">
                  <label className="label cursor-pointer justify-start gap-2">
                    ...
                    <span className="label-text-alt text-xs ml-2">
                      Users can specify their own model from HuggingFace/CivitAI
                    </span>
                  </label>
                </div>
                ...
                {(form_data.metadata?.allow_custom_model_name as boolean) && (
                  <>
                    <div className="alert alert-info">
                      ...
                      <span>
                        When enabled, users can input any Stable Diffusion model from HuggingFace or
                        CivitAI
                      </span>
                    </div>
                        ...
                        {["HuggingFace", "CivitAI", "Custom URL"].map((source) => (
                          <label key={source} className="label cursor-pointer gap-2">
                            <input
                              ...
                              className="checkbox checkbox-sm"
                              checked={(
                                (form_data.metadata?.supported_model_sources as string[]) || [
                                  "HuggingFace",
                                ]
                              ).includes(source)}
                              onChange={(e) => {
                                const current_sources = (form_data.metadata
                                  ?.supported_model_sources as string[]) || ["HuggingFace"];
                      ...
                      onChange={(e) => {
                        if (e.target.checked) {
                          set_form_data({
                            ...form_data,
                            supported_schedulers: [
                              ...(form_data.supported_schedulers || []),
                              scheduler,
                            ],
                          });
                        } else {
                          set_form_data({
                            ...form_data,
                            supported_schedulers:
                              form_data.supported_schedulers?.filter((s) => s !== scheduler) || [],
                          });
                        }
                      }}
                    />
                ...
                <div className="form-control mt-2">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      set_form_data({
                        ...form_data,
                        default_scheduler: e.target.value || undefined,
                      })
                    }
                  >
            ...
            <div className="mt-4">
                        ...
                        if (e.target.checked) {
                          set_form_data({
                            ...
                            supported_prediction_types: [
                              ...(form_data.supported_prediction_types || []),
                              type,
                            ],
                          });
                        } else {
                          set_form_data({
                            ...form_data,
                            supported_prediction_types:
                              form_data.supported_prediction_types?.filter((t) => t !== type) || [],
                          });
                        }
                      }}
                    />
              ...
              {form_data.supported_prediction_types &&
                form_data.supported_prediction_types.length > 0 && (
                  <div className="form-control mt-2">
                    <label className="label">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        set_form_data({
                          ...form_data,
                          default_prediction_type: e.target.value || undefined,
                        })
                      }
                    >
                      <option value="">Select default...</option>
              ...
              <div>
                <label className="label cursor-pointer justify-start gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      set_form_data({ ...form_data, supports_clip_skip: e.target.checked })
                    }
                  />
              ...
              <div>
                <label className="label cursor-pointer justify-start gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      set_form_data({ ...form_data, supports_eta: e.target.checked })
                    }
                  />
              ...
              <div className="md:col-span-2">
                <label className="label cursor-pointer justify-start gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      set_form_data({ ...form_data, supports_tile_size: e.target.checked })
                    }
                  />
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body">
          ...
          <div className="flex gap-2 mt-2">
            ...
            />
            <button type="button" className="btn btn-primary btn-sm" onClick={add_tag}>
              <Plus className="w-4 h-4" />
            </button>
          </div>
        </div>
            ...
            <div className="alert alert-warning mb-4">
              ...
              <div>
                ...
                <ul className="text-sm mt-2 ml-4 list-disc">
                  <li>
                    <strong>default_model_name</strong>: The base SD model to use (e.g.,
                    &quot;stabilityai/stable-diffusion-xl-base-1.0&quot;)
                  </li>
                  <li>
                    <strong>allow_custom_model_name</strong>: Whether users can specify their own
                    models
                  </li>
                  <li>
                    <strong>supported_model_sources</strong>: Which sources are allowed
                    (HuggingFace, CivitAI, etc.)
                  </li>
                  <li>
                    <strong>example_loras</strong>: Array of example LoRA configurations
                  </li>
                  <li>
                    <strong>unet_name</strong>: Custom U-Net model URL (optional)
                  </li>
                </ul>
              </div>
            </div>
