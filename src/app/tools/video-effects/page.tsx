    ...
    <div className="w-full min-h-full flex flex-col items-center justify-start bg-base-100 p-8 relative">
      ...
      {loading && (
        <div className="w-full flex flex-col items-center justify-center mt-8 mb-4">
          <span className="loading loading-spinner loading-lg text-jade mb-2" aria-label="Generating video" role="status"></span>
          <span className="text-base font-semibold text-jade">AI is creating your video...</span>
        </div>
      )}
      ...
      {show_settings && (
        ...
        >
          ...
          {/* Options row */}
          <div className="w-full flex flex-row flex-wrap gap-4 md:gap-6 items-stretch justify-between bg-transparent">
            {/* Model selection */}
            <div className="flex-1 min-w-[220px] bg-white/80 rounded-2xl border border-base-300 shadow-md p-5 flex flex-col gap-3 transition-all duration-200 hover:shadow-xl focus-within:ring-2 focus-within:ring-jade relative group">
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="ml-1 text-base-400 cursor-help" title="Choose the AI model for video generation.">?</span>
              </div>
              <select
            ...
            {selected_model?.is_image_to_video && (
              <div className="flex-1 min-w-[220px] bg-white/80 rounded-2xl border border-base-300 shadow-md p-5 flex flex-col gap-3 transition-all duration-200 hover:shadow-xl focus-within:ring-2 focus-within:ring-jade relative group">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="text-lg font-bold text-base-900">Image Source</span>
                  <span className="ml-1 text-base-400 cursor-help" title="Provide an image URL or upload an image to guide the video.">?</span>
                </div>
            ...
            {/* Aspect Ratio */}
            <div className="flex-1 min-w-[180px] min-h-[280px] bg-white/80 rounded-2xl border border-base-300 shadow-md p-5 flex flex-col gap-3 items-center justify-center transition-all duration-200 hover:shadow-xl focus-within:ring-2 focus-within:ring-jade relative group">
              <div className="flex items-center gap-2 mb-1 w-full">
                <FaExpandArrowsAlt className="text-jade text-lg" />
                <span className="text-lg font-bold text-base-900">Aspect Ratio</span>
                <span className="ml-1 text-base-400 cursor-help" title="Choose the aspect ratio for your video.">?</span>
              </div>
            ...
            <div className="flex-1 min-w-[140px] bg-white/80 rounded-2xl border border-base-300 shadow-md p-5 flex flex-col gap-3 items-center justify-between transition-all duration-200 hover:shadow-xl focus-within:ring-2 focus-within:ring-jade relative group">
              <div className="flex items-center gap-2 mb-1 w-full">
                ...
                <span className="text-lg font-bold text-base-900">Duration</span>
                <span className="ml-1 text-base-400 cursor-help" title="Choose the length of the generated video.">?</span>
              </div>
              <select
                className="select select-bordered w-full text-lg font-semibold bg-base-100 border border-base-300 focus:border-jade focus:ring-2 focus:ring-jade-focus transition text-base rounded-lg px-3 py-2 hover:border-jade"
